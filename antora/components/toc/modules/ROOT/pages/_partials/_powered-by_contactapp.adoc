...
The _Contact App_ is a contact management application (like xref:powered-by.adoc#estatio[Estatio]) developed for and deployed at link:http://eurocommercial.com[Eurocommercial].
...
Apache Isis' support for xref:ug:fun:ugfun.adoc#jaxb[JAXB view models]
