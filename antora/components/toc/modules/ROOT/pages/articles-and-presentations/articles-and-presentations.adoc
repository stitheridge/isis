...
* *Book: xref:toc:ROOT:books/books.adoc#DDD-using-NO[Domain Driven Design using Naked Objects], Dan Haywood*
...
* *Book: xref:toc:ROOT:books/books.adoc#Naked-Objects[Naked Objects], Richard Pawson and Robert Matthews.*
