...
[TIP]
====
Alternatively you could "do it properly" and create your xref:ug:vw:ugvw.adoc#custom-bootstrap-theme[own Bootstrap theme], as described in the xref:ug:btb:ugbtb.adoc#[Extending] chapter.
====
