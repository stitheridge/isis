...
The Wicket viewer supports the bookmarking of both domain objects and query-only (xref:rg:ant:rgant.adoc#semantics[@Action(semantics=...)]) actions.
...
The xref:ug:vw:ugvw.adoc#recent-pages[Recent Pages] also lists recently visited pages, selected from a drop-down.
