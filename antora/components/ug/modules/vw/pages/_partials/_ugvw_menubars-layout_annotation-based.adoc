...
The annotations-based approach for arranging the placement of menu items is achieved through the xref:rg:ant:rgant.adoc#rgant-DomainServiceLayout[`@DomainServiceLayout`] annotations.
