...
The Apache Isis application library provides the xref:rg:cms:rgcms.adoc#_rgcms_classes_value-types_Blob[Blob] value type (binary large objects) and also the xref:rg:cms:rgcms.adoc#Clob[Clob]
