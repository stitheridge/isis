...
The (non-ASF) link:http://platform.incode.org[Incode Platform^] provides a number of extensions to the Wicket viewer (leveraging the APIs described in xref:ug:vw:ugvw.adoc#extending[Extending the Wicket viewer] section, later.
