...
If you want to use the first approach (the `.jdo` file), you'll find that you can download the effective XML representation of domain entities using the xref:rg:cms:rgcms.adoc#downloadJdoMetadata[downloadJdoMetadata] mixin action available in prototyping mode.
