...
In the xref:ug:fun:ugfun.adoc#simpleapp-archetype[SimpleApp archetype] this is defined under the "neo4j" profile so can be activated using `-P neo4j`.
...
* run the xref:ug:fun:ugfun.adoc#simpleapp-archetype[SimpleApp archetype] (v1.8.0)
