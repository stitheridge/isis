...
|`--manifest`
|FQCN
|Fully qualified class name of the xref:rg:cms:rgcms.adoc#AppManifest[`AppManifest`] to use to bootstrap the system. +
...
|`--fixture`
|FQCN
|Fully qualified class name of the fixture (extending xref:rg:cms:rgcms.adoc#FixtureScript[`FixtureScript`]) to be run to setup data. +
