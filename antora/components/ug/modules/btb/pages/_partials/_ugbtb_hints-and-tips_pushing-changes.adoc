...
<3> the xref:rg:cms:rgcms.adoc#addTo[`addTo...()`] method increments the derived properties
<4> the xref:rg:cms:rgcms.adoc#removeFrom[`removeFrom...()`] method similarly decrements the derived properties
