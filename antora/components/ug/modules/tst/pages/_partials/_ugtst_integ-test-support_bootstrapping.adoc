...
The recommended way to bootstrapping of integration tests is done using a xref:rg:cms:rgcms.adoc#AppManifest2-bootstrapping[`Module`] implementation, along with the `IntegrationTestAbstract3` superclass.

For example, the xref:ug:fun:ugfun.adoc#simpleapp-archetype[SimpleApp archetype]'s integration tests all inherit from this class:
