...
The `TickingClockFixture` is a pre-built fixture script that resets the date/time returned by the xref:rg:svc:rgsvc.adoc#ClockService[`ClockService`] to a known value.
