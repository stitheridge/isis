...
The xref:rgsvc.adoc#HealthCheckService[`HealthCheckService`] SPI allows applications to provide an implementation of that service which can indicate the overall health of the application.
