...
However, it's recommended to implement the xref:rg:cms:rgcms.adoc#Module[`Module`] interface because this allows the module to specify its direct dependencies; from these all transitive dependencies are calculated.
