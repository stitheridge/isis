...
+
This is discussed in more detail below, in the section on xref:ug:fun:ugfun.adoc#events[events].
...
xref:ug:fun:ugfun.adoc#domain-services[here].
====


== Hexagonal Arch. + services

It's worth extending the xref:ug:fun:ugfun.adoc#hexagonal-architecture[Hexagonal Architecture] to show where domain services fit in:
