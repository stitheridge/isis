...
+
This feature is deprecated because xref:ug:fun:ugfun.adoc#mixins[mixins] are equivalent in functionality with a simpler programming model.
...
While for long-term maintainability we do recommend the naming conventions described xref:ug:fun:ugfun.adoc#organizing-services[above], you can get away with far fewer services when just prototyping a domain.
