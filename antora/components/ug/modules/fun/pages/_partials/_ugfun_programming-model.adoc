...
You can learn more about extending Apache Isis programming model xref:ug:btb:ugbtb.adoc#programming-model[here].
====
...
(Alternatively, these UI hints can be defined in a supplementary xref:ug:vw:ugvw.adoc#layout[`.layout.xml`] file.
