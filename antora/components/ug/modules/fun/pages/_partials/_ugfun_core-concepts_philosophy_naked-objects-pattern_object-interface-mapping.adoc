...
MetaWidget has a number of ideas in common with Apache Isis (we compare Apache Isis' with MetaWidget xref:ug:fun:ugfun.adoc#metawidget[here]), in particular the runtime generation of a UI for domain objects.
