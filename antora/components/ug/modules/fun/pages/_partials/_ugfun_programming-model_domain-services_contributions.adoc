...
Instead, contribute the behaviour using xref:ug:fun:ugfun.adoc#mixins[mixins].
====
...
More information about contributions can be found xref:ug:fun:ugfun.adoc#contributed-members[here].  More information
about using contributions and mixins to keep your domain application decoupled can be found xref:ug:fun:ugfun.adoc#_ugfun_building-blocks_types-of-domain-objects_mixins[here] and xref:ug:fun:ugfun.adoc#contributions[contributed services]).
