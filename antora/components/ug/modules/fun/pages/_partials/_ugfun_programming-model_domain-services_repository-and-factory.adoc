...
The repository/factory uses an injected xref:rg:svc:rgsvc.adoc#RepositoryService[`RepositoryService`] to both instantiate new objects and to query the database for existing objects of a given entity type.
