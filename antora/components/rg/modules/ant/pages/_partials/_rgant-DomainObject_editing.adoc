...
The default is `AS_CONFIGURED`, meaning that the xref:rg:cfg:rgcfg.adoc#configuring-core[configuration property] `isis.objects.editing` is used to determine the whether the object is modifiable:
