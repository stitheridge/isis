...
For more on sidebar vs modal dialogs, see xref:ug:vw:ugvw.adoc#sidebar-vs-modal-dialogs[Wicket viewer features].

The prompt style is influenced by two xref:ug:vw:ugvw.adoc#configuration-properties[configuration properties]:
