...
[TIP]
====
It is also possible to use xref:rg:ant:rgant.adoc#_rgant-CollectionLayout_hidden[`@CollectionLayout#hidden()`] or using xref:ug:vw:ugvw.adoc#file-based[file-based layout] such that the collection can be hidden at the view layer.
