...
The grouping of multiple domain services actions within a single drop-down is managed by the xref:rg:ant:rgant.adoc#menuOrder[`@DomainServiceLayout#menuOrder()`] attribute.
