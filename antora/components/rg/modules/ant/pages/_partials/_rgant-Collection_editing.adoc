...
* whether the domain object has been configured as immutable through the xref:rg:ant:rgant.adoc#editing[`@DomainObject#editing()`] attribute
...
* xref:rg:ant:rgant.adoc#editing[properties]
* xref:rg:ant:rgant.adoc#editing[domain object]
