...
This is as an alternative to implementing xref:rg:cms:rgcms.adoc#layout[`layout()`] reserved method.
...
This attribute can also be applied to xref:rg:ant:rgant.adoc#layoutUiEvent[view models].
