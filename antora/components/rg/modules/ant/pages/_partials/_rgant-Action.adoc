...
|xref:rg:ant:rgant.adoc#associateWith[`associateWith()`]
|_memberId_ +
("")
|associates an action with another property or collection of the action.

|xref:rg:ant:rgant.adoc#associateWith[`associateWith-Sequence()`]
|_memberId_ +
("")
|associates an action with another property or collection of the action.
...
|the event type to be posted to the xref:rg:svc:rgsvc.adoc#EventBusService[`EventBusService`] to
...
|xref:rg:ant:rgant.adoc#invokeOn[`invokeOn()`]
...
|`AS_CONFIGURED`, `ENABLED`, `DISABLED` +
(`AS_CONFIGURED`)
|whether the action invocation should be published to the registered xref:rg:svc:rgsvc.adoc#PublisherService[`PublisherService`].

|xref:rg:ant:rgant.adoc#restrictTo[`restrictTo()`]
...
|xref:rg:ant:rgant.adoc#semantics[`semantics()`]
...
|xref:rg:ant:rgant.adoc#typeOf[`typeOf()`]
|(none)
