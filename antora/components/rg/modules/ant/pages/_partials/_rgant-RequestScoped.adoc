...
One of the built-in domain services that uses this annotation is xref:rg:svc:rgsvc.adoc#Scratchpad[`Scratchpad`], intended to allow the arbitrary sharing of data between objects.  Here is the full source code of this service is:
