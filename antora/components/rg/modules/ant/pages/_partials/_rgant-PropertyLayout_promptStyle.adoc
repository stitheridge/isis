...
If the attribute is not set, then the value of the xref:ug:vw:ugvw.adoc#configuration-properties[configuration property] `isis.viewer.wicket.promptStyle` is used.
...
Alternatively, the `promptStyle()` can be specified using xref:ug:vw:ugvw.adoc#file-based[file-based layouts].
