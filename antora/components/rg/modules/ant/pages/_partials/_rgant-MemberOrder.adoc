...
[IMPORTANT]
====
As this is an important topic, there is a xref:ug:vw:ugvw.adoc#layout[separate chapter] that discussed object layout in full.
====


[TIP]
====
The annotation is one of a handful (others including xref:rg:ant:rgant.adoc#_rgant-Collection[`@Collection`], xref:rg:ant:rgant.adoc#rgant-Property[`@Property`])
