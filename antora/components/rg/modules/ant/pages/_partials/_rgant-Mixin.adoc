...
For further discussion on using mixins, see xref:ug:fun:ugfun.adoc#mixins[mixins] in the user guide.
...
|xref:rg:ant:rgant.adoc#method[`method()`]
...
xref:rg:ant:rgant.adoc#nature[`@DomainObject#nature()`] annotation with a nature of `MIXIN`.
