...
`NotPersistent`]
|Used to determine whether to enforce or skip some xref:ug:btb:ugbtb.adoc#custom-validator[metamodel validation] for `@Column` versus equivalent Isis annotations.
