...
The `repositoryFor()` attribute is intended for domain services (probably with a xref:rg:ant:rgant.adoc#nature[`nature=DOMAIN`]) that are intended to act as repositories for domain entities.
