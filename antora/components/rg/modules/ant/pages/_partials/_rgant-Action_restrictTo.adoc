...
By default actions are available irrespective of the xref:rg:cfg:rgcfg.adoc#deployment-types[deployment mode].  The `restrictTo()` attribute specifies whether the action should instead be restricted to only available in prototyping mode.
