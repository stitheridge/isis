...
|xref:rg:fis:rgfis.adoc#AuthenticationSessionProvider[`o.a.i.core.commons.` +
`authentication.` +
...
|xref:rg:fis:rgfis.adoc#CommandDtoServiceInternal[`o.a.i.c.m.s.command` +
...
xref:rg:ant:rgant.adoc#command[`@Action#commandExecuteIn()`] or
xref:rg:ant:rgant.adoc#command[`@Property#commandExecuteIn()`].
|`CommandDtoService-` +
...
|xref:rg:fis:rgfis.adoc#InteractionDtoServiceInternal[`o.a.i.c.m.s.ixn` +
`InteractionDtoServiceInternal`]
|Creates DTO for the current execution of an action invocation or property edit, for use either as a reified command or for implementations of the xref:rg:svc:rgsvc.adoc#PublisherService[`PublisherService`].
|`CommandDtoService-` +
`InternalServiceDefault` +
``isis-core-metamodel``
|
