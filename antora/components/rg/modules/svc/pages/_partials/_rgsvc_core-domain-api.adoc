...
|xref:rg:svc:rgsvc.adoc#ClockService[`o.a.i.applib.` +
`services.clock` +
`ClockService`]
...
|xref:rg:svc:rgsvc.adoc#ConfigurationService[`o.a.i.applib.` +
`services.config` +
...
|xref:rg:svc:rgsvc.adoc#EventBusService[`o.a.i.applib.` +
`services.eventbus` +
`EventBusService`]
|Programmatically post events to the internal event bus.  Also used by Apache Isis itself to broadcast domain events:

* xref:rg:ant:rgant.adoc#domainEvent[`Action#domainEvent()`]
* xref:rg:ant:rgant.adoc#domainEvent[`Property#domainEvent()`]
* xref:rg:ant:rgant.adoc#domainEvent[`Collection#domainEvent()`]
|`EventBusServiceJdo` +
``o.a.i.core`` +
``isis-core-runtime``
|

|xref:rg:svc:rgsvc.adoc#FactoryService[`o.a.i.applib.` +
`services.factory` +
`FactoryService`]
...
|xref:rg:svc:rgsvc.adoc#Scratchpad[`o.a.i.applib.` +
`services.scratchpad` +
`Scratchpad`]
...
|xref:rg:svc:rgsvc.adoc#UserService[`o.a.i.applib.` +
`services.xactn` +
`UserService`]
