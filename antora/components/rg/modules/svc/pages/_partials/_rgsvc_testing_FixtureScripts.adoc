...
The `FixtureScripts` service provides the ability to execute xref:ug:tst:ugtst.adoc#api-and-usage[fixture scripts].

The default implementation of this service, `FixtureScriptsDefault`, uses the associated xref:rg:svc:rgsvc.adoc#FixtureScriptsSpecificationProvider[`FixtureScriptsSpecificationProvider`] to obtain a `FixtureScriptsSpecification`.
...
This are listened to by the xref:rg:svc:rgsvc.adoc#QueryResultsCache[`QueryResultsCache`] to disable caching during this period.
...
The default implementation of this domain service interacts with xref:rg:svc:rgsvc.adoc#FixtureScriptsSpecificationProvider[`FixtureScriptsSpecificationProvider`].
