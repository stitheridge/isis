...
The `ExecutionParameters` object in turn is responsible for parsing the string parameter passed when executing fixtures through the UI to the xref:rgsvc.adoc#FixtureScripts[`FixtureScripts`] domain service.
