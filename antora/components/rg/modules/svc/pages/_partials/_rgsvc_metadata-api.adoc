...
|xref:rg:svc:rgsvc.adoc#ApplicationFeatureRepository[`o.a.i.applib.` +
`services.appfeat` +
...
|xref:rg:svc:rgsvc.adoc#LayoutService[`o.a.i.applib.` +
`services.layout` +
`LayoutService`]
...
|xref:rg:svc:rgsvc.adoc#MetamodelService[`o.a.i.applib.` +
`services.metamodel` +
`MetaModelService`]
...
|xref:rg:svc:rgsvc.adoc#ServiceRegistry[`o.a.i.applib.` +
`services.registry` +
`ServiceRegistry`]
...
|xref:rg:svc:rgsvc.adoc#SwaggerService[`o.a.i.applib.` +
`services.swagger` +
`SwaggerService`]
