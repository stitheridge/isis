...
|xref:rg:svc:rgsvc.adoc#BookmarkService[`o.a.i.applib.` +
`services.bookmark` +
`BookmarkService`]
...
|xref:rg:svc:rgsvc.adoc#EmailService[`o.a.i.applib.` +
`services.email` +
`EmailService`]
...
|xref:rg:svc:rgsvc.adoc#JaxbService[`o.a.i.applib.` +
`services.jaxb` +
`JaxbService`]
...
|xref:rg:svc:rgsvc.adoc#MementoService[`o.a.i.applib.` +
`services.memento` +
`MementoService`]
|Capture a serializable memento of a set of primitives or xref:rg:svc:rgsvc.adoc#BookmarkService[bookmarks].  Primarily used internally, eg in support of commands/auditing.
...
|xref:rg:svc:rgsvc.adoc#XmlSnapshotService[`o.a.i.applib.` +
