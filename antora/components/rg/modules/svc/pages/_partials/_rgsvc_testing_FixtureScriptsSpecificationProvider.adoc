...
The `FixtureScriptsSpecificationProvider` configures the xref:rg:svc:rgsvc.adoc#FixtureScripts[`FixtureScripts`] domain service, providing the location to search for fixture scripts and other settings.
...
The xref:ug:fun:ugfun.adoc#simpleapp-archetype[SimpleApp archetype] has a simple implementation of this service:
