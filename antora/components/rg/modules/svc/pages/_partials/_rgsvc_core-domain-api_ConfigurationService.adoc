...
The `ConfigurationService` allows domain objects to read the configuration properties aggregated from the various xref:rg:cfg:rgcfg.adoc#configuration-files[configuration files].
