...
|xref:rg:svc:rgsvc.adoc#AuditerService[`o.a.i.applib.` +
`services.audit` +
`AuditerService`]
...
|xref:rg:svc:rgsvc.adoc#PublisherService[`o.a.i.applib.` +
`services.publish` +
`PublisherService`]
...
|xref:rg:svc:rgsvc.adoc#UserRegistrationService[`o.a.i.applib.` +
`services.userreg` +
