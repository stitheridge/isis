...
<2> ditto, but with translatable string, for xref:ug:btb:ugbtb.adoc#i18n[i18n support].
...
To use an alternative implementation, implement the `MessageService` interface and use xref:rg:ant:rgant.adoc#_rgant-DomainServiceLayout_menuOrder[`@DomainServiceLayout#menuOrder()`] (as explained in the xref:rg:svc:rgsvc.adoc#overriding-the-services[introduction] to this guide).
