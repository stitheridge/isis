...
You can gain access to the relevant JDO API using the xref:rg:svc:rgsvc.adoc#IsisJdoSupport[`IsisJdoSupport`] domain service.
...
<3> use the injected xref:rg:svc:rgsvc.adoc#IsisJdoSupport[`IsisJdoSupport`] service to obtain the `PersistenceManager`.
