...
Subclass of xref:rg:cms:rgcms.adoc#AbstractDomainEvent[`AbstractDomainEvent`] for properties.
...
----
<1> The `Default` nested static class is the default for the xref:rg:ant:rgant.adoc#domainEvent[`@Property#domainEvent()`] annotation attribute.
