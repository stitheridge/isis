...
Subclass of xref:rg:cms:rgcms.adoc#AbstractDomainEvent[`AbstractDomainEvent`] for collections.
...
----
<1> The `Default` nested static class is the default for the xref:rg:ant:rgant.adoc#domainEvent[`@Collection#domainEvent()`] annotation attribute.
