...
Subclass of xref:rg:cms:rgcms.adoc#AbstractDomainEvent[`AbstractDomainEvent`] for actions.
...
* link back to the xref:rg:svc:rgsvc.adoc#CommandContext[`CommandContext`] service's `Command` object
...
----
<1> The `Default` nested static class is the default for the xref:rg:ant:rgant.adoc#domainEvent[`@Action#domainEvent()`]
...
<4> Deprecated, use xref:rg:svc:rgsvc.adoc#_rgsvc_application-layer-api_CommandContext[`CommandContext`] or (better)  xref:rg:svc:rgsvc.adoc#InteractionContext[`InteractionContext`]instead.
