...
* xref:rg:cms:rgcms.adoc#ActionDomainEvent[`ActionDomainEvent`]

* xref:rg:cms:rgcms.adoc#PropertyDomainEvent[`PropertyDomainEvent`]

* xref:rg:cms:rgcms.adoc#CollectionDomainEvent[`CollectionDomainEvent`]
