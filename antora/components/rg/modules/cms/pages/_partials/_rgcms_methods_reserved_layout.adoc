...
This may be specified using annotations such as xref:rg:ant:rgant.adoc#_rgant_MemberOrder[`@MemberOrder`]xref:rg:ant:rgant.adoc#_rgant_DomainObjectLayout[`@DomainObjectLayout`] and the like,  but it much more commonly specified using an xref:ugvw.adoc#file-based [XML layout file].
