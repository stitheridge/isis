...
* the release manager performing post-release tasks, for either a xref:support:cgcom:cgcom.adoc#post-release-successful[successful] or an unsuccessful vote (latter documented below).
