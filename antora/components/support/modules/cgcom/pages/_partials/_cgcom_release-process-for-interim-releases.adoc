...
[NOTE]
====
The procedure developed here was put together for the team working on the xref:toc:ROOT:powered-by/powered-by.adoc#estatio[Estatio app], which maintains its own link:https://github.com/incodehq/isis[fork on github] and uses link:https://www.cloudbees.com/[CloudBees] as a Jenkins build server/private Maven repo.
====
