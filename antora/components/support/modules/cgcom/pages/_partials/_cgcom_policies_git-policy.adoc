...
For non-committers we typically expect more detail again; see the xref:support:dg:dg.adoc#contributing[contributing] page for the longer format recommended for contributors to use.