...
//This appendix lists the (IntelliJ) live templates available for xref:support:dg:dg.adoc#_dg_asciidoc[writing documentation] using Asciidoc.  Instructions for installing the templates can be found xref:support:dg:dg.adoc#live-templates[here].
//
...
//for example:
//
//`\xref:support:dg:dg.adoc#cutting-a-release[Cutting a release\]`
//
//|`addg`
...
//for example:
//
//`\xref:support:dg:dg.adoc#asciidoc-templates[Asciidoc templates\]`
//
//|xref:support:dg:dg.adoc#asciidoc-templates[Asciidoc templates]
//
//
...
//for example:
//
//`\xref:rg:ant:rgant.adoc#main[Core annotations]`
//
//|xref:rg:ant:rgant.adoc#main[Core annotations]
//
//
...
//for example:
//
//`\xref:rg:cfg:rgcfg.adoc#configuring-core[Configuring Core]`
//
//|xref:rg:cfg:rgcfg.adoc#configuring-core[Configuring Core]
//
//
...
//for example:
//
//`\xref:rg:cms:rgcms.adoc#AbstractService[`AbstractService`]`
//
//|xref:rg:cms:rgcms.adoc#AbstractService[`AbstractService`]
//
//
...
//for example:
//
//`\xref:rg:cms:rgcms.adoc#AppManifest-bootstrapping[`AppManifest` bootstrapping]`
//
//|xref:rg:cms:rgcms.adoc#AppManifest-bootstrapping[`AppManifest` bootstrapping]
//
//
...
//for example:
//
//`\xref:rg:mvn:rgmvn.adoc#validate[validate goal]`
//
//|xref:rg:mvn:rgmvn.adoc#validate[validate goal]
//
//
...
//
//|`adrgnt`
//|`\xref:rg:ant:rgant.adoc#ttt[`@xxx#ttt()`]`
//
...
//for example:
//
//`\xref:rg:ant:rgant.adoc#semantics[`@Action#semantics()`]`
//
//|xref:rg:ant:rgant.adoc#semantics[`@Action#semantics()`]
//
//
//
//|`adrgsa`
//|`\xref:rg:svc:rgsvc.adoc#xxx[`xxx`]`
//
...
//
//|xref:rg:svc:rgsvc.adoc#ContentMappingServicef[`ContentMappingService`]
//
//
//
//
...
//for example:
//
//`\xref:ug:fun:ugfun.adoc#core-concepts[Core concepts]`
//
//|xref:ug:fun:ugfun.adoc#core-concepts[Core concepts]
//
//
...
//for example:
//
//`\xref:ug:vw:ugvw.adoc#customisation[Customisation]`
//
//|xref:ug:vw:ugvw.adoc#customisation[Customisation]
//
//
...
//for example:
//
//`\xref:ug:vro:ugvro.adoc#ro-spec[RestfulObjects specification]`
//
//|xref:ug:vro:ugvro.adoc#ro-spec[RestfulObjects specification]
//
//
...
//for example:
//
//`\xref:ug:sec:ugsec.adoc#shiro-caching[Caching and other Shiro Features]`
//
//|xref:ug:sec:ugsec.adoc#shiro-caching[Caching and other Shiro Features]
//
//
...
//for example:
//
//`\xref:ug:tst:ugtst.adoc#bdd-spec-support[BDD Spec Support]`
//
//|xref:ug:tst:ugtst.adoc#bdd-spec-support[BDD Spec Support]
//
//
...
//for example:
//
//`\xref:ug:btb:ugbtb.adoc#externalized-configuration[Externalized Configuration]`
//
//|xref:ug:btb:ugbtb.adoc#externalized-configuration[Externalized Configuration]
//
//
