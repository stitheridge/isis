...
//To help write the Asciidoc text itself, we provide some xref:support:dg:dg.adoc#asciidoc-templates[Asciidoc templates].
...
Since this can only be done by Apache Isis committers, the process for doing this is described in the xref:support:cgcom:cgcom.adoc#asciidoc-publish-procedure[committers' guide].
