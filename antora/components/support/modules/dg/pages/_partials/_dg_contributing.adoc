...
This page explains how you can contribute to Apache Isis. You'll probably also want xref:support:dg:dg.adoc#_dg_ide[set up your IDE] and learn xref:support:dg:dg.adoc#building-isis[how to build Apache Isis].
...
Next, make changes to your files using the usual commands (see also our xref:support:dg:dg.adoc#git-cookbook[git cookbook] section):
