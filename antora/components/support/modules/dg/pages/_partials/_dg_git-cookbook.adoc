...
* xref:support:dg:dg.adoc#building-isis[building Apache Isis]
* xref:support:dg:dg.adoc#contributing[Contributing]
* xref:support:cgcom:cgcom.adoc#git-policy[Git policy]
...
The xref:support:dg:dg.adoc#_dg_contributing[contributing] page describes the workflow for non-committers.  The xref:support:cgcom:cgcom.adoc#git-policy[Git policy] page describes a workflow for Apache Isis **committers**.
